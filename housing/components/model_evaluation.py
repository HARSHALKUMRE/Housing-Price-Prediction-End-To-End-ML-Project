...
class ModelEvaluation:
    ...
    def update_evaluation_report(self, model_evaluation_artifact: ModelEvaluationArtifact):
        try:
            ...
            logging.info(f"Prevous eval result: {model_eval_content}")
            eval_result = {
                BEST_MODEL_KEY: {
                    MODEL_PATH_KEY: model_evaluation_artifact.evaluate_model_path,
                }
            }
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        try:
            ...
            if model is None:
                ...
                model_evaluation_artifact = ModelEvaluationArtifact(evaluate_model_path=trained_model_file_path,
            ...
            if metric_info_artifact is None:
                response = ModelEvaluationArtifact(is_model_accepted=False,
                                                   evaluate_model_path=trained_model_file_path
                                                   )
            ...
            if metric_info_artifact.index_number == 1:
                ...
                logging.info(f"Trained model is not better that existing model hence not accepting trained model.")
                model_evaluation_artifact = ModelEvaluationArtifact(evaluate_model_path=trained_model_file_path,
